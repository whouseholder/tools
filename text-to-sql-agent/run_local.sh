...
echo "  • How many customers are on premium plans?"
echo ""
...
echo ""
echo "To test follow-up visualizations:"
echo "  1. Ask any question above (with Auto-Viz OFF)"
echo "  2. Then ask: 'show that as a pie chart'"
echo "  3. Then ask: 'make it a bar chart'"
echo "  4. Charts will update in the right panel!"
echo ""
